...
export default function AdminSettingsPage() {
  const [settings, setSettings] = useState({ welcomeText: '', googleCalendarUrl: '', countryCode: 'BD' });
  ...
  return (
    <Layout title="Settings — Admin">
      <AdminLayout title="⚙️ Site Settings">
        ...
        <div className={styles.card}>
          <h3 className={styles.sectionTitle}>📅 Calendar Settings</h3>
          <div className={styles.field}>
            <label className={styles.label}>Google Calendar URL</label>
            <input
              type="url"
              ...
              className={styles.input}
            />
            <span className={styles.hint}>Add your Google Calendar public link for sync</span>
          </div>
          <div className={styles.field}>
            <label className={styles.label}>Country Code (for holidays)</label>
            <input
              type="text"
            ...
            />
            <span className={styles.hint}>2-letter ISO code (BD = Bangladesh, US = United States, etc.)</span>
          </div>
        </div>
