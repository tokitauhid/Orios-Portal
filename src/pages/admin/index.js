...
import { getAll, getSettings, saveSettings } from "@site/src/auth";
...
export default function AdminDashboard() {
  ...
  const handleCheckApi = async () => {
    ...
    try {
      ...
      if (res.status === 500) {
        alert(
          "❌ KV binding is not found in Cloudflare. Check kv_config.js and your environment binding.",
        );
      ...
      alert(
        "❌ API is entirely unreachable. Are you running the Cloudflare worker backend locally?",
      );
    } finally {
          ...
          <div className={styles.settingsGrid}>
            <div className={styles.field}>
              ...
              <span className={styles.hint}>
                Displayed below "Welcome to Orios Class" on the homepage.
              </span>
            </div>
            <div className={styles.field}>
            ...
            <div className={styles.field}>
              ...
              <span className={styles.hint}>
                Binding name is controlled in kv_config.js and Cloudflare
                environment.
              </span>
            </div>
          </div>
